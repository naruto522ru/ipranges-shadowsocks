...
add_domain() {
curl --max-time 30 --retry-delay 3 --retry 10 -4s -# https://raw.githubusercontent.com/naruto522ru/ipranges/refs/heads/main/microsoft/domain.txt > /tmp/"$1"_domain.txt
...
curl --max-time 30 --retry-delay 3 --retry 10 -4s -# https://raw.githubusercontent.com/naruto522ru/ipranges/refs/heads/main/microsoft/ipv4_merged.txt | sed 's/\/32//g' >> microsoft/ipv4.acl
